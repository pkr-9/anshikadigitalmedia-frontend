...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      // Try to get label from item, fallback to config
      const itemLabel =
        (item &&
          typeof item === "object" &&
          "label" in item &&
      ...
      if (labelFormatter && itemLabel) {
        return (
          <div className={cn("font-medium", labelClassName)}>
            {labelFormatter(itemLabel, payload)}
          </div>
        );
      }
      ...
      return (
        <div className={cn("font-medium", labelClassName)}>{itemLabel}</div>
      );
